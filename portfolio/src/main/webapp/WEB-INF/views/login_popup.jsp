...
<form id="frm" name="frm">
  <div class="container">
    ...
    <div>
	    ...
	    <label>우편번호</label>
	    <input type="text" id="post1" style="width: 70px;">
	    <button style="padding: 15px; margin: 5px 0 22px 0;" onclick="sample4_execDaumPostcode();">우편번호 검색</button><br>
	    <label>도로명 주소</label>
	    <input type="text" placeholder="Enter Addr" id="addr1" name="addr1">
	    <label>지번 주소</label>
	    <input type="text" placeholder="Enter Addr" id="addr2" name="addr2">
    </div>
    <button type="button" id="regSubmit" name="regSubmit" class="registerbtn">가입 확인</button>
  </div>
</form>
